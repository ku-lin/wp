...
- 工具位置：`D:\tool\取证\malcat_win313_lite\bin\malcat.exe`
- 当前状态：已在 D:\tool 中确认位置
- 来源线索：`D:\tool`

## 比赛中怎么用

malcat 的核心价值是：样本静态分析和十六进制/结构化查看工具，适合恶意样本、未知二进制快速分析。 比赛时先确认输入文件、目标地址、凭据和权限，再逐步增加参数。
...
- GUI 工具，未抓取命令行参数；双击 malcat.exe 打开样本。

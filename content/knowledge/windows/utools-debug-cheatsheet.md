---
title: "utools-debug-cheatsheet"
lastmod: 2026-04-12T00:37:40+08:00
draft: false
---
# utools-debug-cheatsheet

- 平台：Windows（D:\tool）
- 使用领域：通用 / uTools
- 主要用途：调试速查资料插件/目录。
- 工具位置：`D:\tool\uTools\utools-debug-cheatsheet`
- 当前状态：已在 D:\tool 中确认位置
- 来源线索：`D:\tool`

## 比赛中怎么用

utools-debug-cheatsheet 的核心价值是：调试速查资料插件/目录。 比赛时先确认输入文件、目标地址、凭据和权限，再逐步增加参数。

...
- 工具位置：`D:\tool\CTF\Web\Struts2扫描\Struts2_19.73.jar`
- 当前状态：已在 D:\tool 中确认位置
- 来源线索：`D:\tool`

## 比赛中怎么用

Struts2扫描 的核心价值是：Struts2_19.73.jar 图形/Java 工具，用于 Struts2 历史漏洞检测。 比赛时先确认输入文件、目标地址、凭据和权限，再逐步增加参数。

## 常用命令

```bash
java -jar Struts2_19.73.jar
```

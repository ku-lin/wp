...
- 工具位置：`/usr/bin/gdb-multiarch`
- 当前状态：已在 Kali SSH 环境中确认
- 来源线索：`比赛环境手册/tool/gdb-multiarch.md`

## 比赛中怎么用

gdb-multiarch 的核心价值是：支持多架构目标的 GDB，常用于 ARM/MIPS 等交叉架构调试。 比赛时先确认输入文件、目标地址、凭据和权限，再逐步增加参数。

## 常用命令

```bash
gdb-multiarch ./arm_chall
```

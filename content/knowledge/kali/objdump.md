...
- 工具位置：`/usr/bin/objdump`
- 当前状态：已在 Kali SSH 环境中确认
- 来源线索：`比赛环境手册/tool/objdump.md`
...
objdump: supported targets: elf64-x86-64 elf32-i386 elf32-iamcu elf32-x86-64 pei-i386 pe-x86-64 pei-x86-64 elf64-little elf64-big elf32-little elf32-big pe-bigobj-x86-64 pe-i386 pe-bigobj-i386 pdb srec symbolsrec verilog tekhex binary ihex plugin
